...
function CreatePost() {
  ...
  const handleCorrectContent = async () => {
    try {
      ...
      toast.error("Error correcting content. Please try again later.");
    }
  };
  ...
  return (
    <div className="create-post-form-container">
      ...
      <form onSubmit={createNewPost} encType="multipart/form-data">
        ...
        <button type="button" onClick={handleCorrectContent} className="correct-content-btn">
          Correct Content
        </button>
